...
const userTypes: UserTypeOption[] = [
  {
    ...
    description: 'HetheTrack team member with full system access',
  ...
  },
  {
    id: 'business_user',
    title: 'Business User',
    description: 'Consultant managing tenement responsibilities',
  ...
  },
  {
    id: 'client',
    title: 'Client',
    description: 'Tenement holder or stakeholder',
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-emerald-100 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Join Mining Hub</h1>
          ...
          <div className="flex items-center justify-center mb-8">
            <div className="flex items-center space-x-4">
              <div className={`flex items-center justify-center w-8 h-8 rounded-full ${
                step === 'user-type' ? 'bg-emerald-600 text-white' : 'bg-emerald-100 text-emerald-600'
              }`}>
                {step === 'details' ? <Check className="w-4 h-4" /> : '1'}
              </div>
              <div className={`w-16 h-1 rounded-full ${
                step === 'details' ? 'bg-emerald-600' : 'bg-gray-200'
              }`}></div>
              <div className={`flex items-center justify-center w-8 h-8 rounded-full ${
                step === 'details' ? 'bg-emerald-600 text-white' : 'bg-gray-200 text-gray-400'
              }`}>
                2
              </div>
            </div>
              ...
              <div className="space-y-4">
                {userTypes.map((userType) => (
                  <button
                    ...
                    className={`w-full p-6 rounded-xl border-2 transition-all duration-200 hover:shadow-md text-left ${
                      selectedUserType === userType.id 
                        ? `${userType.color} border-current shadow-md` 
                  ...
                  >
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        <h3 className="font-semibold text-gray-900 mb-1">{userType.title}</h3>
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Role: <span className="font-medium text-emerald-600">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="company" className="block text-sm font-medium text-gray-700 mb-2">
                    Company {selectedUserType !== 'client' && <span className="text-red-500">*</span>}
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      required={selectedUserType !== 'client'}
                    />
                  </div>
                </div>
